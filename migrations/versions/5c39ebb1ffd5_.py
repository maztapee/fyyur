...
Revision ID: 5c39ebb1ffd5
Revises: 
Create Date: 2022-08-19 22:31:39.927290
...
def upgrade():
    ...
    sa.Column('web_url', sa.String(length=120), nullable=True),
    sa.Column('seeking_talent', sa.Boolean(), nullable=True),
    sa.Column('talent_description', sa.String(length=240), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('Genre',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('genre_class', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
